    ...
    >
      <div className="bg-teal-50 w-full h-full md:w-[800px] md:h-[600px] shadow-2xl md:flex rounded-md overflow-auto ">
        <img
          ...
          className="cursor-pointer block md:hidden float-right m-2"
        />
        <div className="basis-1/2 p-5 md:shadow-2xl shadow-gray-400 m-0 ">
          ...
          <div className="flex justify-between">
            <div className="w-60 text-gray-500">
              Картофель отборный, перец, соль
            </div>
            <div className="text-2xl">{volume()}г</div>
          </div>
        ...
        <div className="basis-1/2">
          <div className="flex justify-between items-center p-2">
            <div className="mx-2 font-medium text-xl">Добавить соусы</div>
            <div className="">
              <img
                src={close}
                alt=""
